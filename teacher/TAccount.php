                                ...
                                <form class="form-material" id="editAccountForm">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" id="example-text" name="example-text" class="form-control text-muted" placeholder="enter name" value="Teacher ABC" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <input type="email" id="example-email" name="example-email" class="form-control text-muted" placeholder="enter email" value="teacherABC@gmail.com" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire(
                        ...
                        window.location.href = "TAccount.php";
                    })
                }
            })
        })
