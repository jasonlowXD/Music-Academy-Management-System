                                ...
                                ?>
                                    ...
                                    // IF GOT COMMENT 
                                        ...
                                        while ($row2 = $result2->fetch_assoc()) {
                                            ...
                                            // IF THE COMMENT IS MAKE BY PARENT (CURRENT USER)
                                            if ($parent_id != null && $parent_id == $userID && $teacher_id == null) {
                                        ?>
                                                <div id="<?php echo $comment_id ?>" class="comment-row pb-1 border-bottom deletableCommentDiv">
                                                    <div class="comment-text w-100">
                                                        <div class="d-flex no-block">
                                                            <h5 class="mr-auto"><strong><?php echo $parent_name; ?></strong></h5>
                                                            <div class="ml-auto">
                                            ...
                                            // IF THE COMMENT IS MAKE BY TEACHER 
                                            else if ($teacher_id != null && $parent_id == null) {
                                            ?>
                                                <div class="comment-row pb-1 border-bottom">
                                                    <div class="comment-text w-100">
                                                        <div class="d-flex">
                                                            <h5><strong><?php echo $teacher_name; ?></strong></h5>
                                                        </div>
                                                        <p class="m-b-10 m-t-10"><?php echo $comment_content; ?></p>
                                                        <small class="text-primary"><?php echo $datetime_display; ?></small>
                                                    </div>
                                ...
                                <form action="addComment.php" method="post" id="addCommentForm">
                                    <div class="row">
                                        ...
                                        <div class="col-2 p-l-0 text-right">
                                            <button type="submit" class="btn btn-info btn-circle"><i class="fa fa-paper-plane-o"></i> </button>
                                        </div>
                                    </div>
                                </form>
                            </div>
