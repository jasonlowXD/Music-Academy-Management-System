    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> <a class="waves-effect waves-dark" href="PChildren.php"><i class="icon-user"></i><span class="hide-menu">Children</span></a>
                </li>
                <li> <a class="waves-effect waves-dark" href="PTeacher.php"><i class="icon-menu"></i><span class="hide-menu">Teacher</span></a>
                </li>
