            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Teacher Contact List</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Teacher Contact</h4>
                                <hr>
                                <div class="d-flex">
                                    <div class="mr-auto">
                                ...
                                <div class="table-responsive ">
                                    <table id="mytable" class="table m-t-5 table-hover contact-list" data-page-size="5">
                                        ...
                                        <tbody>
                                            ...
                                            if ($conn) {
                                                $sql = "SELECT DISTINCT TEACHER.TEACHER_ID, TEACHER.TEACHER_NAME, TEACHER.TEACHER_EMAIL, TEACHER.TEACHER_PHONE_NUM FROM TEACHER LEFT JOIN CHILD ON TEACHER.TEACHER_ID = CHILD.TEACHER_ID WHERE CHILD.PARENT_ID = '$userID'";
