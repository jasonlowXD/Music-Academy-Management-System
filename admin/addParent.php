...
if ($conn) {
    ...
    $sql = "SELECT COUNT(*) FROM ADMIN WHERE ADMIN_EMAIL =  '$parentEmail' ";
    ...
    $sql0 = "SELECT COUNT(*) FROM TEACHER WHERE TEACHER_EMAIL =  '$parentEmail' ";
    ...
    $sql1 = "SELECT COUNT(*) FROM PARENT WHERE PARENT_EMAIL =  '$parentEmail' ";
